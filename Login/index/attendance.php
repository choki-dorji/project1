...
$sql = "SELECT  count(COL3) as TOT  from inoutdata where COL3 = '$id' ";
  ...
  <table class="table table-bordered">
    ...
    <tbody>
      <tr>
        ...
        <td colspan="1" style="text-align: center;"><?php echo $e4; ?></td>
        <td colspan="1" style="text-align: center;"><?php echo $e5; ?> </td>
        <td colspan="1" style="text-align: center;"><?php echo $e6; ?> </td>
