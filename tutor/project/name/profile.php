                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow" role="presentation">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small">
                                    ...
                                    </span><img class="border rounded-circle img-profile" src="assets/img/user.png"></a>
                                    <div
                    ...
                    <div class="col-lg-4">
                        <div class="card mb-3">
                            <div class="card-body text-center shadow">
                                <img class="rounded-circle mb-3 mt-4" src="assets/img/dogs/download.png" width="160" height="160">
                            ...
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 font-weight-bold">Tutor Data</p>
                                    </div>
                                    <div class="card-body">
                                        <form>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="Name">
                                                        <strong>
                                                            Name: <?php echo $_SESSION['Name']; ?></strong></label></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="email"><strong>Gender:<?php echo $_SESSION['gender']; ?></strong></label></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <!-- <div class="form-group"><label for="last_name"><strong>Module:<?php $_SESSION['module'] ; ?></strong></label></div>
                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="form-group"><label for="address"><strong>Email ID:<?php echo $_SESSION['email']; ?> </strong></label></div>

                                            <div class="form-group"><label for="address"><strong>Phone:<?php echo $_SESSION['phone']; ?> </strong></label></div>
